 ...
 * Awesome: the free set is solid only, and solid glyphs at 22px read heavier
 * than the hairline rules they sit between. Stroked outlines also keep the
 * section a step quieter than the illustrated cards in Currently Focused On
 * below it.
 */
const strokeProps = {
  viewBox: "0 0 24 24",
...
// 22px for the rows, 18px for the glyph inside a button.
