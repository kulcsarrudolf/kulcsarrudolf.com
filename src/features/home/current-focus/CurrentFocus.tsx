    ...
    <div>
      ...
      <div className="relative">
        <div
          ...
          className="hide-scrollbar relative flex cursor-grab items-stretch gap-4 overflow-x-auto overflow-y-hidden snap-x snap-mandatory active:cursor-grabbing focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-brand"
